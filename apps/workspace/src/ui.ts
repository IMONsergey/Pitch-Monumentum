...
<div class="spike-app">
  <header class="spike-top">
    ...
    <a href="/" class="spike-btn">Workspace</a>
  </header>
  <div class="spike-shell">
    ...
    <aside class="spike-right" aria-label="Inspector"></aside>
  </div>
