...
const css = `
  ...
  .pitch-media-grid{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-top:7px}.pitch-media-actions{display:flex;gap:6px;margin-top:8px}.pitch-media-action{flex:1;height:29px;border:1px solid #4c5b3b;border-radius:6px;background:#171e14;color:#d9f5a2;font-size:10px;cursor:pointer}.pitch-media-action.secondary{border-color:var(--line);background:#151a20;color:#aab2bd}
`;
