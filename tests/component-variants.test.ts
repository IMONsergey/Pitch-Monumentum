...
function definition(): ComponentDefinition { return { schemaVersion: "0.1", id: "component_button", name: "Button", widthDU: 320, heightDU: 96, rootIds: ["bg", "label"], elements: [
...
], slots: [{ id: "fill_bg", name: "Background", kind: "fill", targetElementId: "bg" }, { id: "text_label", name: "Label", kind: "text", targetElementId: "label" }] }; }
function variants(): ComponentVariantSet { return { schemaVersion: "0.1", id: "button_variants", componentId: "component_button", name: "Button variants", axes: [
...
test("variant validation rejects unknown axis values and slot kind mismatches", () => {
  assert.throws(() => resolveComponentVariant(definition(), variants(), { tone: "ghost" }), /Invalid tone variant value/);
  const bad = variants();
