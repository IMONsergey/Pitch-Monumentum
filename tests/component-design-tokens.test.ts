...
function slide(): SlideDocument {
  const shape: TokenizedSceneElement = { id: "card", type: "shape", shape: "roundRect", fill: "#112233", semanticRole: "visual", geometry: { x: 200, y: 200, width: 600, height: 320 }, zIndex: 2, origin: "user", exportStrategy: "native", dependencies: [], tokenBindings: { fill: "primary" } };
  return { id: "s1", order: 0, title: "Tokens", archetype: "freeform", semantic: { purpose: "test", takeaway: "test", questionAnswered: "test", narrativeRole: "test", claimIds: [], evidenceRefs: [], audienceRelevance: "test", density: "sparse" }, scene: [shape], status: "draft", qaIssueIds: [], dependencyIds: [] };
}
function deck(): DeckDocument { return { schemaVersion: "0.1", id: "deck", title: "Tokens", canvas: { widthDU: 1920, heightDU: 1080, duPerInch: 144, aspectRatio: "16:9" }, briefId: "brief", narrativeId: "narrative", designSystemId: "design", sourceIds: [], claimIds: [], activeBranchId: "branch_main", createdAt: "2026-08-08T00:00:00Z", updatedAt: "2026-08-08T00:00:00Z", slides: [slide()] }; }
