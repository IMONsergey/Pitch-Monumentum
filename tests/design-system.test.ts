...
const theme: DeckTheme = {
  schemaVersion: "0.1", id: "theme_brand", name: "Brand",
  colors: { primary: "#112233", text: "#202124", accent: "#55AA22" },
  fonts: { display: "Inter", body: "Arial" }, typeScalePt: { display: 48, body: 24 }, spacingDU: { s: 12, m: 24, l: 48 },
};
...
function fixture(): DeckDocument {
  return {
    ...
    slides: [{ id: "s1", order: 0, title: "Theme", archetype: "freeform", semantic: { purpose: "test", takeaway: "test", questionAnswered: "test", narrativeRole: "test", claimIds: [], evidenceRefs: [], audienceRelevance: "test", density: "sparse" }, scene: [
...
function element(deck: DeckDocument, id: string): TokenizedSceneElement { return deck.slides[0].scene.find((item) => item.id === id)! as TokenizedSceneElement; }
